...
const RenderAllBlogs: React.FC<RenderAllBlogsProps> = ({
  ...
  query allFAQPages {
    allContentfulResource(
      filter: {
        ...
        heading: {
          nin: ["Dummy Resource", "Dummy Resource | Referenced section"]
        }
...
export const FAQSection: React.FC = () => (
  <StaticQuery query={query} render={RenderAllBlogs} />
);
