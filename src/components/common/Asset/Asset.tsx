...
export const YouTubeEmbed: FC<YouTubeEmbedProps> = ({videoId, title}) => (
	<AspectRatio ratio={16 / 9}>
		<LiteYouTubeEmbed id={videoId} adNetwork params="rel=0" rel="0" poster="maxresdefault" title={title} noCookie />
	</AspectRatio>
);

const Asset = forwardRef<HTMLDivElement, AssetProps>(({asset, youtubeVideoURL, width, objectFit}, ref) => {
