const CAPI_BASE_URI = process.env.GATSBY_CAPI_BASE_URI ?? 'http://localhost:8888';
export const CHANNEL_COMPARISION_API = CAPI_BASE_URI + '/api/cs/v1/channel-comparision/';
