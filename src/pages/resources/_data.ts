...
export const RESOURCES_DATA: ResourceItem[] = [
  ...
  {
    title: "Removing Barriers and Boosting Adherence to Drive Adoption and Growth",
  ...
  {
    title: "Overcoming Low Enrollment and High Abandonment Rates Through Seamless Patient Access",
    topics: ["patient", "access", "data", "commercial"],
    type: "casestudy",
  ...
  {
    title: "Engaging Providers to Overcome Adoption and Adherence Challenges to Deliver Brand Growth",
    topics: ["patient", "access", "data", "commercial"],
    type: "casestudy",
  ...
  {
    title: "Designing a Direct-to-Patient Program that Turns Cost Barriers into Accelerated Patient Success",
