  ...
  <div className="xl-container">
    <div className="roi-banner">
      <div className="roi-text">
        ...
        <p>The calculator was built by PHIL's Commercial Insights architects to translate our sophisticated GTN modeling to provide a clear view into a brand's GTN potential.</p>
