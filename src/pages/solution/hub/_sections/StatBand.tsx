  ...
  <div className="stat-bar">
    <div className="xl-container">
      <div className="section-head stat-bar-head">
        ...
        <p className="lead lead--full">PHIL offers 10+ years experience building technology-driven access programs for branded retail and specialty-lite therapies.</p>
      </div>
    </div>
  </div>
  <div className="xl-container">
    <div className="stat-banner" id="statBanner">
      ...
      <div className="stat-item"><p className="stat-num" data-target="4.9" data-decimals="1" data-suffix="/5.0">4.9/5.0</p><p className="stat-label">Patient Satisfaction Score</p>
