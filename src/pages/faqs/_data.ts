  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer: `<p>We have a real-time data dashboard with AI-powered insights that provides in-depth program observations at the script, provider, territory, and payer level. Additionally, we have a dedicated Client Success &amp; Commercial Insights team that partners closely with clients to actively review program data and provide strategic recommendations and optimization plans.</p><p><a href="/demo/" target="_blank" rel="noopener">Click here to book a full walk-through of PHIL's comprehensive data tools</a>.</p>`,
      },
      {
