    ...
    items: [
      {
        ...
        answer: `<p>PHIL is a medication access platform designed to improve patient outcomes and brand performance for retail and specialty-lite brands. Through <a href="https://phil.us/solution/core/" target="_blank" rel="noopener">PHIL Core</a>, our digital hub, and <a href="https://phil.us/solution/direct/" target="_blank" rel="noopener">PHIL Direct</a>, our Direct-to-Patient (DTP) solution, we enable seamless medication access via our integrated pharmacy network and our own PHIL cash pharmacies, delivering simple, affordable paths to therapy.</p>`,
      },
      {
        question:
          "What types of medications are best suited for the PHIL platform?",
        answer: `<p>Our platform is purpose-built to support branded retail and specialty-lite therapies — medications that are self-administered, pharmacy benefit, controlled or non-controlled, and often require prior authorization and patient support services.</p>`,
      },
      {
        question:
      ...
      },
      {
        ...
        answer: `<p>PHIL is redefining medication access for branded retail and specialty-lite therapies. Traditional access channels rely on fragmented, legacy workflows that burden providers and leave patients facing high costs and long delays.</p><p>PHIL replaces this outdated friction with a modern, technology-first platform. Designed with ultimate flexibility, our platform structures can be fully whitelabeled to align with your brand's unique footprint. By streamlining the entire prescription journey, we provide patients cost transparency, unlock real-time visibility for brands, and ensure patients can effortlessly access, afford, and stay on their prescribed therapies.</p><p>Curious if your brand could benefit from partnering with PHIL? <a href="https://phil.us/demo/" target="_blank" rel="noopener">Contact us for a discovery call</a>.</p>`,
      },
    ],
  },
  {
...
export const PATIENT_FAQS: FlatFaqItem[] = [
  {
...
export const PROVIDER_CATEGORIES: FaqCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "We cannot find PHILRx in the EMR — what should we do?",
  ...
  },
  {
    ...
    items: [
      {
        question:
          "What happens if a patient does not enroll with PHILRx after I send their prescription?",
      ...
      {
        question:
          "Is there a place where I can proactively see all of the patients I've sent through PHILRx?",
      ...
      {
        question:
          "What happens if a patient does not have access to a mobile device or computer?",
  ...
  },
  {
    ...
    items: [
      {
        question:
          "Can PHILRx support patients where English is not their first or preferred language?",
  ...
  },
  {
    ...
    items: [
      {
        question:
          "Is there one place where prescribers can see all of the Rx they've written versus only the updates where action needs to be taken?",
        answer: `<p>We send a weekly HCP summary fax/email consisting of the patient cases with a pending action (either from the patient or HCP), along with the scripts that have been successfully processed/shipped (typically at the bottom of the fax — may be on the 2nd or 3rd page).</p>`,
      },
    ],
  },
  {
    ...
    items: [
      {
        question:
          "How long does it take for PHILRx to initiate the PA after receiving the script?",
      ...
      {
        question:
          "Can the PA process be started even before the patient completes their PHILRx registration?",
  ...
  },
  {
    ...
    items: [
      ...
      {
        question:
          "How can offices change their default preference and frequency of receiving summary updates?",
