      ...
      <div className={classes.tyPage}>
        <header className={classes.tyHero}>
          ...
          <div className="xl-container">
            {/* top header — logo + eyebrow, above the two-column row */}
            <div className={`${classes.tyHeader} ${classes.tyRise}`}>
              <Link
                to="/"
                className={classes.tyLogoLink}
                aria-label="PHIL — go to home"
              >
                <img
                  className={classes.tyLogo}
                  src="/images/demo-phil-logo-white.png"
                  alt="PHIL"
                />
              </Link>
              <div className={classes.tyHeaderRow}>
                ...
                {/* desktop: sits in line with the eyebrow, above the video */}
            ...
            <div className={classes.tyHeroInner}>
              ...
              <div className={classes.tyRise}>
                ...
                <p className={classes.tySub}>
                  Our Sales team will be in touch shortly. Please check your
                  inbox for a confirmation email with next steps. We look
