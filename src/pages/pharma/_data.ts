...
export const STATS = [
  ...
  { value: "4.9/5.0", label: "Patient Satisfaction Score", variant: "v6", trustpilot: true },
] as const;
...
export const STAKEHOLDERS = [
  {
    ...
    icon: "chart",
    problem: "Traditional retail is eroding net revenue and limiting visibility into script outcomes.",
  ...
  },
  {
    ...
    icon: "truck",
    problem: "Lack of end-to-end control in traditional retail channels is restricting the ability to optimize distribution and fulfillment.",
